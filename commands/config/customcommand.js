...
message.channel.send(new MessageEmbed().setColor(message.guild.me.displayHexColor).setDescription(`❌ custom Command Limit Reached **(10)**\n\n[Upgrade Premium Here for unlimited commands](https://thisisbot.tk/premium)`))
