...
module.exports = class extends Command {
    ...
    async run(message, args) {
      ...
      if (args.length < 1) {
        ...
        .setDescription(`❌ ${language.antiinvites1}`));
      }
      ...
      if (args.includes('disable')) {
        ...
        .setColor(message.guild.me.displayHexColor)
        .setDescription(`❌ ${language.moduleDisabled}`));
        ...
        await Guild.findOne({
          ...
          return message.channel.send( new MessageEmbed()
          .setColor(message.guild.me.displayHexColor)
          .setDescription(`✔️ ${language.antiinvites3}`));
        });
        return;
      }
      ...
      if (args.includes('enable')) {
        ...
        if(guildDB.antiInvites === true) return message.channel.send( new MessageEmbed()
        .setColor(message.guild.me.displayHexColor)
        .setDescription(`❌ ${language.moduleEnabled}`));
        ...
        await Guild.findOne({
          ...
          return message.channel.send( new MessageEmbed()
          .setColor(message.guild.me.displayHexColor)
          .setDescription(`✔️ ${language.antiinvites4}`));
        });
        return;
      }
    }
