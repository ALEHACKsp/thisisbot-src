...
module.exports = class extends Command {
  constructor(...args) {
    super(...args, {
      ...
      examples: ["decline @rico OERKSOAE underage"],
...
message.channel.send(new discord.MessageEmbed().setColor(message.client.color.green).setTitle(`Application Declined!`).setDescription(`✔️ I have sucessfully declined this application.\n\n**Application ID:** ${id}\n**Declined by:** ${message.author.tag}\n**Reason:** ${reason}`))

if(app.dm === true){
member.send(new discord.MessageEmbed().setColor(message.client.color.red).setTitle(`Application Declined`).setDescription(`❌ Hey ${member.user.tag}, your application was Declined.\n\n**Application ID:** ${id}\n**Declined by:** ${message.author.tag}\n**Reason:** ${reason}`)).catch(()=>{
