...
module.exports = class extends Command {
 ...
 if(guild.reactionDM === false) return message.channel.send(new MessageEmbed()
  ...
  .setDescription(`❌ DMs are already disabled`)
  .setFooter(`https://thisisbot.tk`)
   .setColor(client.color.red)
 )
        guild.updateOne({
...
message.channel.send(new MessageEmbed()
   .setAuthor(message.author.tag, message.author.displayAvatarURL())
  .setDescription(`❌ Reaction Role DMs have been disabled!`)
  .setFooter(`https://thisisbot.tk`)
   .setColor(client.color.red)
 )
    })
 ...
 if(guild.reactionDM === true) return message.channel.send(new MessageEmbed()
   .setAuthor(message.author.tag, message.author.displayAvatarURL())
  .setDescription(`❌ DMs are already enabled`)
  .setFooter(`https://thisisbot.tk`)
   .setColor(client.color.red))
        guild.updateOne({
          reactionDM: true
...
message.channel.send(new MessageEmbed()
   .setAuthor(message.author.tag, message.author.displayAvatarURL())
  .setDescription(`❌ Reaction Role DMs have been enabled!`)
  .setFooter(`https://thisisbot.tk`)
   .setColor(client.color.red)
 )
