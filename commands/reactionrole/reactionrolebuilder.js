...
module.exports = class extends Command {
  ...
  .setDescription(`❌ Reaction Builder Cancelled!`)
  .setFooter(`https://thisisbot.tk`)

  const cancelledEmbed2 = new MessageEmbed()
    .setAuthor(message.author.tag, message.author.displayAvatarURL())
  .setDescription(`❌ Wrong Response, Reaction Builder Cancelled!`)
  .setFooter(`https://thisisbot.tk`)

    const timeEnd = new MessageEmbed()
    .setAuthor(message.author.tag, message.author.displayAvatarURL())
  .setDescription(`❌ Time has Ended, Reaction Builder Cancelled!`)
  .setFooter(`https://thisisbot.tk`)
