...
module.exports = class extends Command {
    constructor(...args) {
      super(...args, {
        name: 'vote',
        description: 'ThisIsBots\s vote page',
        category: 'Utility',
        cooldown: 5
      });
    }
    ...
    async run(message) {
      ...
      .setDescription(`__**Vote**__\n${checkDBLVote ? `\`In ${ms(user.lastVoted - Date.now() + DBL_INTERVAL, { long: true })}\`` : '[\`Available Now!\`](https://discord-botlist.eu/bots/835605460970110996/vote)'}\n\n__**Rewards:**__\n`)
