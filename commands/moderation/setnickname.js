...
module.exports = class extends Command {
    constructor(...args) {
      super(...args, {
        ...
        category: 'Moderation',
        usage: '<user> [reason]',
        examples: [ 'setnickname @thisisrico', 'setnickname @rico "this is a nickname" ' ],
        guildOnly: true,
    ...
    if (nickname.length > 32) {
      ...
      try {
        ...
        const embed = new MessageEmbed()
          ...
          .setDescription(`✔️ | **${oldNickname}**'s nickname was set to **${nickname}** ${logging && logging.moderation.include_reason === "true" ?`\n\n**Reason:** ${reason}`:``}`)
          .setColor(message.guild.me.displayHexColor);
