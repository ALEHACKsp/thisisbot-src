...
module.exports = class extends Command {
    constructor(...args) {
      super(...args, {
        ...
        category: 'Moderation',
        usage: '<user> [reason]',
        examples: [ 'warn @Rico Please do not swear.' ],
        guildOnly: true,
...
let language = require(`../../data/language/${guildDB.language}.json`)
 ...
 if (!mentionedMember) {
      return message.channel.send(new Discord.MessageEmbed()
          .setDescription(`❌ | ${language.warnMissingUser}`)
...
await message.guild.members.unban(mentionedMember.user, `Auto Punish / ${language.softbanResponsible}: ${message.author.tag}`);
          ...
          message.channel.send(new Discord.MessageEmbed().setColor(message.client.color.green).setDescription(`Auto Punish triggered, ${action} **${mentionedMember.user.tag}** ✔️`))
