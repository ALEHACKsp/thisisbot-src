...
const embed = new MessageEmbed()
.setDescription(`❌ | The current guild has no banned users.`)
.setColor(client.color.green)

message.channel.send(embed).catch(()=>{})
} else {
const embed = new MessageEmbed()
.setDescription(`✔️ | ${language.unbanSuccess} **${array.length}** Users from the guild. \n\n**Users:**\n${array.join(" - ")} ${logging && logging.moderation.include_reason === "true" ?`\n\n**Reason:** ${reason}`:``}`)
.setColor(client.color.green)
...
if(userrz){
const embed = new MessageEmbed()
.setDescription(`✔️ | ${language.unbanSuccess} ${userrz.tag} ${logging && logging.moderation.include_reason === "true" ?`\n\n**Reason:** ${reason}`:``}`)
.setColor(client.color.green)
...
.setDescription(`❌ | ${language.unbanInvalidID}`)
...
const embed = new MessageEmbed()
.setDescription(`✔️ | ${language.unbanSuccess} ${userr.tag} ${logging && logging.moderation.include_reason === "true" ?`\n\n**Reason:** ${reason}`:``}`)
.setColor(client.color.green)
