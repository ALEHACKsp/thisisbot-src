...
.setDescription(`❌ | ${language.softbanNoUser}`)
.setColor(client.color.red));

if (member === message.member) 
return message.channel.send( new MessageEmbed()
.setDescription(`❌ | ${language.softbanSelfUser}`)
.setColor(client.color.red));

if (member.roles.highest.position >= message.member.roles.highest.position)
return message.channel.send( new MessageEmbed()
.setDescription(`❌ | ${language.softbanEqualRole}`)
.setColor(client.color.red));

if (!member.bannable)
return message.channel.send( new MessageEmbed()
.setDescription(`❌ | ${language.softbanNotBannable}`)
.setColor(client.color.red));
...
.setDescription(`✔️ | ${language.softbanSuccess} **${member.user.tag}** ${logging && logging.moderation.include_reason === "true" ?`\n\n**Reason:** ${reason}`:``}`)
