...
window.onload = () => {
    ...
    let editorHolder = document.querySelector('.editorHolder'),
        ...
        toRGB = (hex, reversed, integer) => {
            ...
            embed: {
                title: "Hello! :wave:",
                description: "You can use [links](https://thisisbot.tk) \n```\nAnd also code blocks\n```",
                color: 4321431,
                timestamp: new Date().toISOString(),
                url: "https://thisisbot.tk",
                author: {
                    name: "Author name",
                    url: "https://thisisbot.tk",
                    icon_url: "https://cdn.discordapp.com/attachments/842432952955699220/843923368361459722/20210517_094551.jpg"
                },
                thumbnail: {
                    url: "https://cdn.discordapp.com/attachments/842432952955699220/843923368361459722/20210517_094551.jpg"
                },
                image: {
                    url: "https://cdn.discordapp.com/attachments/842432952955699220/843923368361459722/20210517_094551.jpg"
                },
                ...
                fields: [
                    ...
                    {
                        name: "Field 2",
                        value: "You can use custom emojis",
                        inline: false
                    },
                    {
                        name: "Inline field",
