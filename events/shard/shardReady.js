...
.setColor('green')
        webhookClient.send({
          username: 'ThisIsBot User Blacklists',
...
.setColor('green')
        ...
        webhookClient.send({
          username: 'ThisIsBot Guild Unblacklist',
          avatarURL:`${this.client.domain}/logo.png`,
          embeds: [embed]
        });
    }
  ...
  if(user){
    ...
    const rip = new Discord.MessageEmbed()
      ...
      await premiumrip.send({
        username: 'ThisIsBot Loose Premium',
        avatarURL: `${this.client.domain}/logo.png`,
        embeds: [rip],
      }).catch(()=>{});
